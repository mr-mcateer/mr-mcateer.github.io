...
> pipeline. The public dashboard and the the operator-McAteer email must remain in
...
N: what to add, in what order, and how to present it so the user (the operator, and
